  ...
  return (
    <Motion>
        ...
        <div className="portfolio__container">
            ...
            <div class="d-flex w-100 padding-10 justify-content-center">
            

                <div className='contact-div'>
                        <div className='grid-container'>
                            <div className="contact-card">
                                <a href='mailto:bhupendrasam1404@gmail.com' target='_blank'>
                                    <i className="bx bx-mail-send mb-rm-1 contact-icon"></i>
                                    <h4 className='contact-card-header'>Mail</h4>
                                    <p className='contact-card-text'>Bhupendrasam<br/>1404@gmail<br/>.com</p>
                                </a>
                            </div>
                            <div className="contact-card">
                                 <a href='https://www.linkedin.com/in/bhupendrasambare/' target='_blank'>
                                    <i class='bx bxl-linkedin-square mb-rm-1 contact-icon' ></i>
                                    <h4 className='contact-card-header'>Linkedin</h4>
                                    <p className='contact-card-text mt-2rem'>bhupendrasambare</p>
                                </a>
                            </div>
                            <div className="contact-card">
                                 <a href='Tel: +919516138020' target='_blank'>
                                    <i className="bx bx-phone-call mb-rm-1 contact-icon"></i>
                                    <h4 className='contact-card-header'>Contact</h4>
                                    <p className='contact-card-text mt-2rem'>+91 9516 138020</p>
                                </a>
                            </div>
                            <div className="contact-card">
                                 <a href='https://www.instagram.com/bhupendra.sambare/' target='_blank'>
                                    <i class='bx bxl-instagram-alt mb-rm-1 contact-icon' ></i>
                                    <h4 className='contact-card-header'>Instagram</h4>
                                    <p className='contact-card-text mt-2rem'>bhupendra.sambare</p>
                                </a>
                            </div>
                        </div>
                </div>
                ...
                <div className='contact-div'>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 790 563" className='svg' fill="none">
                            <g id="Image">
                                    <g id="g14">
                                            <g id="g16">
                                                    <g id="g22">
