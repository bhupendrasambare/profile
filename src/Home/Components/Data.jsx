...
const Data = () => {
    ...
    const iconStyle = {fontSize:35,backgroundColor:'transparent',color:"white",fontWeight:"bolder"};

  return (
    <div className='home__data'>
        <Slide>
            <h1 className="home__title">Bhupendra sambare
            </h1>
        </Slide>
        ...
        <p className="home__description flex">
            <Slide direction='up' cascade  damping={0.1}>
                <div className='mh-2'>
                    <i className="bx bxl-java"style={iconStyle}></i>
                </div>

                <div className='mh-2'>
                    <i className="bx bxl-javascript"style={iconStyle}></i>
                </div>
            
                <div className='mh-2'>
                    <i className="bx bxl-spring-boot"style={iconStyle}></i>
                </div>
                
                <div className='mh-2'>
                    <i className="bx bxl-react"style={iconStyle}></i>
                </div>

                <div className='mh-2'>
                    <i className="bx bxs-data"style={iconStyle}></i>
                </div>
            </Slide>
        </p>
